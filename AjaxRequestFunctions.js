...
function ShowIlluDeleteCommentsFields(str)
{
    if (str == "")
    {
        document.getElementById("AssociatedWOProgress").innerHTML = "";
    ...
    else
    {
        ...
        xmlhttp.open("GET", "GetDeleteRaisingIO.php?we=" + str, true);
        xmlhttp.send();
        //alert("Ritwik");
    }
}
...
//DELETE IO
        if ($(event.target).is("#DeleteIO"))
        {
            var FormId = "#DeleteIO";
            var DeleteIOID = $("#DeleteIOID").val();

            var dataString = 'DeleteIOID=' + DeleteIOID;
            //alert(dataString);
        }
...
//      Calculating Score for Review IO
        ...
        if ($(event.target).is("#PostAddDraftDelivery"))
        {
            ...
            var dataString = 'extReceivedDate=' + extReceivedDate;
            //alert(dataString);
        }
//IO OWNER ADD
        if ($(event.target).is("#PostAddOWNERQA"))
        {
            ...
            var ErrorCodeQAIO = $("#ErrorCodeIO").val();
            var ErrorDescQAIO = $("#ErrorDescriptionIO").val();
            var QuantityQAIO = $("#QuantityIO").val();
            var GraphicIDQAIO = $("#GraphicIDIO").val();
            var ReceivedDateQAIO = $("#Rdatepicker").val();

            var dataString = 'ErrorCodeQAIO=' + ErrorCodeQAIO + '&ErrorDescQAIO=' + ErrorDescQAIO + '&QuantityQAIO=' + QuantityQAIO + '&GraphicIDQAIO=' + GraphicIDQAIO + '&ReceivedDateQAIO=' + ReceivedDateQAIO;
            //alert(dataString);
        }
        ...
        //IO Send to Owner
        if ($(event.target).is("#PostSNDOWNER"))
        {
            //alert("Ritwik");
            var FormId = "#PostSNDOWNER";
            var SNDDateIO = $("#STOdatepicker").val();
            var dataString = 'SNDDateIO=' + SNDDateIO;
            //alert(dataString);
        }
