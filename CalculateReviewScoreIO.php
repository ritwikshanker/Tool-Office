...
<body>
<form action="" method="POST" id="CalculateQAIO" role="form">
...
<!--                <td><input type="hidden" name="DisplayQAReviewButtonsIO" id="QACalculateReviewID" value="--><?php //echo $row["IO_ID"]; ?><!--" required></td>-->
            </tr>
            <?php
            }
            ?>
