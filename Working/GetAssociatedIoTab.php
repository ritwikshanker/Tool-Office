...
<br><br>
    <ul class="nav nav-tabs nav-justified">
        ...
        <li><a data-toggle="tab" href="#" onclick="ShowIlluAddEditCommentsFields(this.value);" value = "">Illustrator-Add/Edit Comments</a></li>
        <li><a data-toggle="tab" href="#" onclick="ShowSfckIOFields(this.value);" value = "">SFCK-IO</a></li>

        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#"></i>Reviewer - QA
            ...
            <ul class="dropdown-menu">
                ...
                <li><a data-toggle="tab" href="#" onclick="ShowDeleteReviewerQAIOFields(this.value);" value = "">Delete</a></li>
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Owner - QA
                <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a data-toggle="tab" href="#" onclick="ShowEnterOwnerQAFields(this.value);" value = "">Enter Comment/error</a></li>
