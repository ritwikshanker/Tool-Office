...
<body>
    ...
    <ul class="nav nav-tabs nav-justified">
        ...
        <li><a data-toggle="tab" href="#" onclick="ShowPMAddEditComments(this.value);" value = "">PM-Add Edit Comments</a></li>
    </ul>
    
    <div id = "AssociatedWO"></div> <!-- GetAssociatedWO.php, GetAddWOFields.php,  GetEditWOFields.php, GetPMAddEditComments.php -->
