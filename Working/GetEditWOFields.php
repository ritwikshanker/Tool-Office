        ...
        <div class = "container-fluid">
            <table class="table">
                ...
                while ($row = mysqli_fetch_array($result)) {?>
                    <tr>
                        <td><input type = "text" id = "EditWONo<?php $row["WO No"]; ?>"             Value = "<?php echo $row["WO No"];?>"></td>
                        <td><input type = "text" id = "EditATANumber<?php $row["WO No"]; ?>"        Value = "<?php echo $row["ATA Number"];?>"></td>
