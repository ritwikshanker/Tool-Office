...
<body>
    ...
    <div class="nav-side-menu">
        <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li  data-toggle="collapse" data-target="#RIllu" class="collapsed active">
    ...
    <div class = "container-fluid">
        <table class="table">
            ...
            <tr>
                <th>Raised Date</th>
                <td><input type = "text" name = "RaisedDate"></td>
            </tr>
        ...
        <br>
        <input style = "margin-left:35%;" type = "submit" name = "SubmitIllu" value = "Update Illu">
    </div>
