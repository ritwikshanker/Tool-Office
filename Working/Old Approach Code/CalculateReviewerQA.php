...
<body>
        ...
        <nav class="navbar navbar-default">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="AssociatedWO.php">Associated WO</a></li>
        ...
        <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="RQA">
                    <li><a href="AddReviewerQA.php">Add</a></li>
                    <li><a href="EditReviewerQA.php">Edit</a></li>
                    <li><a href="DeleteReviewerQA.php">Delete</a></li>
    ...
    <div class = "container-fluid">
        ...
        <input style = "margin-left:40%;" type = "submit" name = "SubmitRQA" value = "Calculate">
    </div>
