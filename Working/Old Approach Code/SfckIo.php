    ...
    <div class="nav-side-menu">
        <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li class="active">
                  <a href="#"><i class="fa fa-globe fa-lg"></i>SFCK-IO</a>
                </li>  
    ...
    <div class = "container-fluid">
        <table class="table">
            <tr>
                <th>SFCK</th>
                <td>
                    <select type = "text" name = "SFCK">
                        <option selected>Select SFCK</option>
                        <option>Illustrator SFCK</option>
                        <option>Review Comment SFCK </option>
                        <option>Owner Comment SFCK</option>
                    </select>
                </td>
            </tr>
        ...
        <input style = "margin-left:40%;" type = "submit" name = "SubmitSFCK" value = "Submit">
    </div>
